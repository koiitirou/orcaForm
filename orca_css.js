...
(function () {
  ...
  function buildCoreCSS() {
    var lines = [
      ...
      '  position: fixed; top: 1px; right: 12px; width: 28px; height: 28px;',
      ...
      '}',
      '#orca-helper-float-btn:hover { transform: scale(1.15); color: #475569; }',
      ...
      '.setting-label { font-size: 14px; font-weight: 600; color: var(--orca-text-main); display: flex; align-items: center; gap: 6px; }',
      '.setting-desc { font-size: 12px; color: var(--orca-text-sub); margin-top: 6px; line-height: 1.4; }',
      '',
      '.orca-refresh-btn { background: none; border: 1px solid var(--orca-border); border-radius: 4px; cursor: pointer; font-size: 12px; line-height: 1; padding: 2px 4px; color: var(--orca-text-sub); transition: all 0.2s; display: inline-flex; align-items: center; justify-content: center; }',
      '.orca-refresh-btn:hover { color: var(--orca-accent); border-color: var(--orca-accent); background: var(--orca-accent-hover); }',
      '',
